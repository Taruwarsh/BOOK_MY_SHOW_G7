...
const MoviePage = () => {
  ...
  useEffect(() => {
    const requestCast = async () => {
      const getCast = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}/credits?api_key=20e9eb61289b500057554b5df063f221`
      );
  ...
  useEffect(() => {
    const requestSimilar = async () => {
      const getSimilar = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}/similar?api_key=20e9eb61289b500057554b5df063f221`
      );
  ...
  useEffect(() => {
    const requestRecommended = async () => {
      const getRecommended = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}/recommendations?api_key=20e9eb61289b500057554b5df063f221`
      );
  ...
  useEffect(() => {
    const requestMovie = async () => {
      const getMovieData = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}?api_key=20e9eb61289b500057554b5df063f221`
      );
